...
format:
  ...
  pdf:
    title: PSYC BC1101 STATISTICS
    output-file: bc1101-syllabus-sp25.pdf
    
subtitle: "Barnard College, Spring 2025"
---


Professor: Dr. Rob Brotherton (<rbrother@barnard.edu>)   
Office Hours: Wed 1-2PM, 415M Milbank

Lecture time: Tu/Th 10:10-11:25AM  
Lecture venue: 328 Milbank Hall

Section 001 recitation: Wed 9:10-11:00AM, 222 Milbank Hall   

Section 002 recitation: Wed 11:10AM-1:00PM, 222 Milbank Hall    
...
dates <- paste(seq.Date(from = as.Date("2025-01-21"), to = as.Date("2025-05-05"), by = "week"),
               seq.Date(from = as.Date("2025-01-23"), to = as.Date("2025-05-05"), by = "week"), 
               sep = "!") |>
  stringr::str_split(pattern = "!") |>
  unlist()

dates <- c(
  seq.Date(from = as.Date("2025-01-21"), to = as.Date("2025-05-05"), by = "week"),
  seq.Date(from = as.Date("2025-01-23"), to = as.Date("2025-05-05"), by = "week")
) |> 
  sort()
...
recitation_dates <- data.frame(
  Date = seq.Date(from = as.Date("2025-01-22"), to = as.Date("2025-05-05"), by = "week"),
  Topic = "-",
  Recitation = "-",
  Panopto = "-"
  )
...
schedule |> 
  ...
  kableExtra::row_spec(shade_rows, background = "#eeeeee")
