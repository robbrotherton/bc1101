...
function mousemove(e) {
    ...
    var xPosition = d3.pointer(e, overlayRect.node())[0];
    var xCoord = -30 + (xPosition - margin.left)/((w-margin.left-margin.right)/90);
    xCoord = Math.round(xCoord * 10)/10;
    xCoord = Math.max(-18, xCoord);
    updateOverlay(xCoord);
    }
