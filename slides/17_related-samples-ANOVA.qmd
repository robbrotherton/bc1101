...
$F = \dfrac{{MS_{between}}}{{MS_{within}}} = \dfrac{treatment, \ error, \ ind. \ diff.}{error, \ ind. \ diff.}$
:::
...
::: {.center-element style="margin-top: 3em;"}
$F = \dfrac{{MS_{between \ treatments}}}{{MS_{within}}} = \dfrac{treatment, \ error}{error, \ ind. \ diff.}$
:::
...
::: {.center-element style="margin-top: 3em;"}
$F = \dfrac{{MS_{between \ treatments}}}{{MS_{error}}} = \dfrac{treatment, \ error}{error}$
:::

# Calculations

## Calculations: $SS$ and $df$ values
