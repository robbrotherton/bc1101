...
![](covers/04_central-tendency.svg)
...
![](media/central-tendency-balance.svg){width=20em}

![](media/central-tendency-balance-2.svg){.fragment width=20em}
:::
...
::: {.r-stack}
![](media/central-tendency-bar-1.png)

![](media/central-tendency-bar-2.png){.fragment}
:::
