...
card <- function(file, date) {
  ...
  overview <- try(rvest::read_html(here::here("_site", "slides", paste0(file, ".html"))) |>  
...
<p><a href="{file}.html" target="_blank"><img src="covers/{file}.png" class="img-fluid figure-img"></a></p>
</div>
...
<div class="footer">
<a class="btn btn-outline-dark" href="{file}.html" target="_blank" role="button" style="width: 50%">Slides</a><a class="btn btn-outline-dark" href="{file}.html" target="_blank" role="button" style="width: 50%">Panopto</a>
</div>
