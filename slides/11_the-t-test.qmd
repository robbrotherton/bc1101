...
l <- purrr::map2(seq_len(n), colors, ~ {
  i <- .x - 1 # zero-based index to match your js logic
  duration_val <- 300 + (1 - i/(n-1))*3000
  delay_val <- sqrt(i * 20000)
...
canvas {
  ...
  display: block;       /* prevents blurry scaling due to inline rendering */
}
```
