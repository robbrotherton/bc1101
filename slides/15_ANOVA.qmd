...
::: {.column width="50%"}
```{r}
#| style: "font-size: 0.65em; margin-top: 1em;"
table2
table2_footer
```

![](media/anova-populations-3.svg){.invertable width="100%"}
:::
...
If you calculate both the t and F statistics for a two-group, independent-samples design, ____ equals ____ squared.
