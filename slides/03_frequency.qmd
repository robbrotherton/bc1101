...
ggplot(data.frame(x = scores), aes(x)) +
  geom_density() +
...
::: {.fragment .fade-in}
::: {.fragment .fade-out}
![](media/freq-histogram.png){.hide-print style="opacity: 0.5;"}
