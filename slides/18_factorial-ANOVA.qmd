...
<style>
  ...
  .xx-ab:after {
    ...
    height: 0;
    border: 3px dashed var(--text-color);
    transform: translate(-6em, -1em) rotate(90deg) scale(0.5);
  }
...
<!-- [$SS_A$]{.ss-diagram .xx-a .level3} [$SS_B$]{.ss-diagram .xx-b .level3} [$SS_{A*B}$]{.ss-diagram .xx-ab .level3} -->
:::
...
[$df_A$ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; $df_B$ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; $df_{A*B}$]{.ss-diagram .xx-ab .level3}
