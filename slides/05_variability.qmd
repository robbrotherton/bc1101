...
- SD as a measure of opinion polarization
  - James O’Malley: [The Most Critically Divisive Films According To Data](https://www.independent.co.uk/arts-entertainment/films/news/divisive-films-all-time-critics-mother-melancholia-neon-demon-suicide-squad-dark-knight-a8070146.html)
...
sw_table <- sw |> 
  ...
  kableExtra::column_spec(2:4, extra_css = "background: #b7b7dc4a;") |> 
  kableExtra::column_spec(5:7, extra_css = "background: #f5f0bf69;")
```
