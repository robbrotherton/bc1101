...
::: {#power-controls style="align-content: baseline; position: absolute; top: 4em; width: 50%; font-size: 0.7em;"}

<label for="mu-input" style="font-family: KaTeX_Main; font-size: 1em; font-style: italic; height: 1em;">μ = </label>
<input type="text" id="mu-input" class="invertable" name="mu" value="0" style="background: none; border: none; height: 1em; font-family: KaTeX_Main; font-size: 1em; width: 2em; vertical-align: unset;">

<label for="sigma-input" style="font-family: KaTeX_Main; font-size: 1em; font-style: italic; height: 1em;">σ = </label>
<input type="text" id="sigma-input" class="invertable" name="sigma" value="1" style="background: none; border: none; height: 1em; font-family: KaTeX_Main; font-size: 1em; width: 2em; vertical-align: unset;">
...
chart = {
  ...
  var mu, sigma, d, n, alpha, beta, power, xlim, std_err, max_std_err, alpha_x, alpha_x2, showAlt, tails;
  ...
  function updateZAxis() {
    ...
    var zlim = [mu - 12 * std_err, mu + 12 * std_err];
    z.domain([xlim[0], xlim[1]])
    zAxis
      .tickFormat(z => f2((z - mu)/std_err))
      .tickValues(tickSeq)
    svgZAxis.attr("transform", `translate(0,${y(0)})`)
      .call(zAxis);
  }
