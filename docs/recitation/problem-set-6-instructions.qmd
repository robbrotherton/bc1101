---
title: Problem Set 6
subtitle: The $t$-test & Confidence Intervals
...
Step 3: Calculate your test statistic. Do this by adapting the $t$ equation into R code and plugging the appropriate values.
...
So this involves computing some critical $t$ values and multiplying by the estimated standard error, and adding and subtracting that product from the mean.
