...
yScaleEstimates = d3.scaleLinear()
    .domain([20, 0])
    .range([maxHeight - 20, maxHeight * (1 - estimatesSubPanelProportion)])
...
update_svg = {
  ...
  function updatePath() {
      ...
      if (nSamplesDrawn > 201) {
        ...
        timeYAxis = d3.axisLeft(timeY).tickSize(0);
  ...
  populationAndSampleSvg.append("text")
    .text("Under/over-estimation")
    .attr("y", populationPanelHeight * (1 - estimatesSubPanelProportion) + 20)
  populationAndSampleSvg.append("text")
    .text("of parameter")
    .attr("y", populationPanelHeight * (1 - estimatesSubPanelProportion) + 40)
...
var timeYAxis = d3.axisLeft(timeY).tickSize(0)
var timeXAxis = d3.axisTop(timeX).ticks(5).tickSize(0)
  ...
  timeSvg.append("g")
      ...
      .enter().append("line")
        .attr("y1", d => timeY(0)).attr("y2", d => timeY(500))
